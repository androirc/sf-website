...
<div class="article">
    ...
    <div class="footer">
        <div class="share addthis_toolbox addthis_default_style"
            ...
            <a class="addthis_button_tweet" tw:url="<?php echo url_for('article_show', $article, true) ?>" tw:counturl="<?php echo url_for('article_show', $article, true) ?>" tw:via="androirc"></a>

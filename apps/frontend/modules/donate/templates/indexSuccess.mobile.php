<?php slot('title', 'Donate') ?>

<p>AndroIRC is <strong>free</strong> and you can download it <strong>FOR FREE</strong> in the Market. But we have <strong>charges</strong> concerning the server administration. This is why a <strong>donation</strong> would be welcomed and extremely appreciated (this is <strong>not</strong> an obligation).</p>

...
/**
 * ChangeLog filter form base class.
 *
 * @package    androirc
 * @subpackage filter
 * @author     MewT
 ...
 */
abstract class BaseChangeLogFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('change_log_filters[%s]');

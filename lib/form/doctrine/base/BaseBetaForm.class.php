...
/**
 * Beta form base class.
 *
 * @method Beta getObject() Returns the current form's model object
 *
 * @package    androirc
 * @subpackage form
 * @author     MewT
 ...
 */
abstract class BaseBetaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('beta[%s]');
